...
import type { GordonDocument, GordonFolder } from "@/app/components/shared/types";
...
interface Props {
    ...
    onDocClick: (doc: GordonDocument) => void;
...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/gordon-doc");
        const movingFolderId = e.dataTransfer.getData("application/gordon-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/gordon-doc") ||
            Array.from(e.dataTransfer.types).includes("application/gordon-folder")
        );
    }
