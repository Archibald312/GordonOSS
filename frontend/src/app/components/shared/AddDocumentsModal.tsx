...
interface Props {
    open: boolean;
    onClose: () => void;
    onSelect: (documents: GordonDocument[], projectId?: string) => void;
    breadcrumb: string[];
...
export function AddDocumentsModal({
    ...
    const [extraUploadedDocs, setExtraUploadedDocs] = useState<GordonDocument[]>([]);
    ...
    async function handleDelete(ids: string[]) {
        ...
        const docsById = new Map<string, GordonDocument>();
        for (const d of [
            ...standaloneDocuments,
            ...extraUploadedDocs,
            ...projects.flatMap((p) => p.documents ?? []),
