...
import { generateTabularColumnPrompt } from "@/app/lib/gordonApi";
                ...
                <form onSubmit={handleSubmit} className="flex flex-col min-h-0 flex-1">
                    ...
                    <div className="px-6 pt-3 pb-5 overflow-y-auto flex-1">
                        ...
                        <textarea
                            ...
                            placeholder="Write the analysis prompt — describe what Gordon should extract from each document for this column…"
