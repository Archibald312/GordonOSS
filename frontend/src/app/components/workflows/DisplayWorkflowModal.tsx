...
import type { GordonDocument, GordonWorkflow } from "../shared/types";
import { createTabularReview } from "@/app/lib/gordonApi";
...
interface Props {
    workflows: GordonWorkflow[];
    workflow: GordonWorkflow | null;
    onClose: () => void;
}
...
// ---------------------------------------------------------------------------
function AssistantPanel({ workflow }: { workflow: GordonWorkflow }) {
    return (
...
// ---------------------------------------------------------------------------
function TabularPanel({ workflow }: { workflow: GordonWorkflow }) {
...
export function DisplayWorkflowModal({ workflows, workflow, onClose }: Props) {
    ...
    const [selected, setSelected] = useState<GordonWorkflow | null>(workflow);
