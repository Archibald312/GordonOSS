...
import type { GordonWorkflow } from "../shared/types";
...
export function WorkflowList() {
    ...
    const { user } = useAuth();
    const [custom, setCustom] = useState<GordonWorkflow[]>([]);
    const [loading, setLoading] = useState(true);
    const [selected, setSelected] = useState<GordonWorkflow | null>(null);
    ...
    const [typeFilter, setTypeFilter] = useState<GordonWorkflow["type"] | null>(
        null,
    );
    ...
    const getTypeMeta = (type: GordonWorkflow["type"]) =>
        type === "tabular"
