...
import { createWorkflow, updateWorkflow } from "@/app/lib/gordonApi";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onCreated: (workflow: GordonWorkflow) => void;
    editWorkflow?: GordonWorkflow;
    onUpdated?: (workflow: GordonWorkflow) => void;
}
