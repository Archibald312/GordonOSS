...
import { getWorkflow, updateWorkflow } from "@/app/lib/gordonApi";
...
import type { ColumnConfig, GordonWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<GordonWorkflow | null>(null);
