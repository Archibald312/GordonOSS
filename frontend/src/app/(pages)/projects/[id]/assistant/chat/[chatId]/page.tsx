...
export default function ProjectAssistantChatPage({ params }: Props) {
    ...
    const [initialMessages] = useState<GordonMessage[]>(newChatMessages ?? []);
    ...
    const handleCitationClick = (citation: GordonCitationAnnotation) => {
        openTab(
    ...
    const handleEditViewClick = (ann: GordonEditAnnotation, filename: string) => {
                            ...
                            onDragOver={(e) => {
                                ...
                                const isInternal =
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/gordon-doc",
                                    ) ||
                                    Array.from(e.dataTransfer.types).includes(
                                        "application/gordon-folder",
                                    );
